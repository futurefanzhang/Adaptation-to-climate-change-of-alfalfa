...
python /public/home/zhangtianhao/soft/superSFS/superSFS.py 1 10truncatula_outgroup.txt 3 merge_267_allele2_meanDP3-62_miss0.2_addid.plink.vcf merge_267_allele2_meanDP3-62_miss0.2_addid.plink_reverse.vcf  ###功能1，根据外类群反转vcf；10truncatula_outgroup.txt是外类群样本名，3代表10个外类群（20个单倍型）中有三个单倍型就翻转SNP，
...
perl /public/agis/zhouyongfeng_group/zhangfan02/vcf_file/SIFT4G_zm4_database/change_vcf_format_genotype.pl deleterious_vcf_file_all.vcf > deleterious_vcf_file_all_dosage.vcf ##把0/0,0/1,1/1转换成0,1,2格式
